...
<title>Mobile Robot &amp; Robotic Arm — Autonomous Pick, Sort &amp; Store System</title>
<style>
  :root {
    --bg: #ffffff; --fg: #1f2933; --muted: #52606d; --accent: #14646d;
    --card: #f5f7f8; --border: #d9e2e6; --code-bg: #eef2f4;
  }
  @media (prefers-color-scheme: dark) {
    :root {
      --bg: #14181b; --fg: #e4e9ec; --muted: #9aa7af; --accent: #5fd0da;
      --card: #1d2429; --border: #2e3a40; --code-bg: #232c32;
    }
  }
  * { box-sizing: border-box; }
  body {
    margin: 0 auto; max-width: 900px; padding: 2rem 1.25rem 4rem;
    font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
    background: var(--bg); color: var(--fg); line-height: 1.6;
  }
  h1 { font-size: 1.9rem; margin: 0 0 .25rem; color: var(--accent); }
  h2 { font-size: 1.35rem; margin-top: 2.5rem; border-bottom: 2px solid var(--border); padding-bottom: .35rem; }
  ...
  code, pre { font-family: "SF Mono", SFMono-Regular, Consolas, Menlo, monospace; font-size: .88em; }
  ...
  .warn { border-left: 4px solid #c9762c; }
  ul { padding-left: 1.3rem; }
  a { color: var(--accent); }
  .tag {
    display: inline-block; background: var(--card); border: 1px solid var(--border);
    border-radius: 999px; padding: .1rem .7rem; margin: .15rem; font-size: .85rem;
  }
