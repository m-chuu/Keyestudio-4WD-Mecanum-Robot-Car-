...
// ================================================================
//  CalibrateStraightSerial.cpp
//  Simple straight-line calibration:
//    • Set the four wheel speeds by TYPING in the Serial Monitor.
//    • Press IR button 1 to drive all 4 wheels forward and watch it.
//    • Press IR * (or type s) to stop.
//  Adjust, drive again, repeat until the robot tracks straight.
// ================================================================
...
void handleSerial() {
  ...
  printSpeeds();                      // always show the result
}
...
void loop() {
  ...
  // Re-assert every pass (guards a dropped I2C frame).
  if (driving) {
