...
// Verified sensor polarity: white floor ~25 (digitalRead LOW),
// black tape ~750 (digitalRead HIGH).
...
void HomeRobot() {
  ...
  while (!lineFound) {
    ...
    if (millis() - lastReport > 500) {
      ...
      Serial.print(digitalRead(IR_LINE_LEFT_PIN));   Serial.print(F(" "));
      Serial.print(digitalRead(IR_LINE_CENTER_PIN)); Serial.print(F(" "));
      Serial.print(digitalRead(IR_LINE_RIGHT_PIN));
