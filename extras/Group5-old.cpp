...
void setup() {
  Serial.begin(9600);
  pinMode(SENSOR_LEFT, INPUT); pinMode(SENSOR_MID, INPUT); pinMode(SENSOR_RIGHT, INPUT);
...
void loop() {
  ...
  switch (cmd) {
    case CMD_1: {
      ...
      executeSequence(path1, sizeof(path1) / sizeof(path1[0]));
      break;
    }
    ...
    case CMD_2: {
      ...
      executeSequence(path2, sizeof(path2) / sizeof(path2[0]));
      break;
    }
    ...
    case CMD_3: {
      ...
      executeSequence(path3, sizeof(path3) / sizeof(path3[0]));
      break;
    }
    case CMD_4: {
  // ============================================================
...
if (thirdBlueGrabbed) {
  ...
  break;
    ...
    //     {MOVE_BACKWARD, 1, SPEED_START_SLOW},
    //   };
    //   executeSequence(path5, sizeof(path5) / sizeof(path5[0]));
    //   break;
    // }
